##### phase 0 #######################################
# generate fasta file from chr5
## this i downloaded from tair with all teh chr TAIR10_chr_all.fas
...
###### if im playing with beta and pi i can run from here
##### phase 2 #######################################
######################################################
####### run python script ############################
######################################################
...
gunzip chr5_grenenet_subset_ann4.vcf.gz 
