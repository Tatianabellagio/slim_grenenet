...
output_fitness_va_mean="${snakemake_output[output_fitness_va_mean]}"
output_fitness_va_var="${snakemake_output[output_fitness_va_var]}"
...
slim \
    ...
    -d "output_fitness_va_mean='$output_fitness_va_mean'" \
    -d "output_vfitness='$output_vfitness'" \
    -d "output_fitness_va_var='$output_fitness_va_var'" \
