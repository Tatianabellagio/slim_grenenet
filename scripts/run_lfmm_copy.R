...
geno_file = 'results/arq_highfreq_lowpoly_betaprop/lfmm_generation5/geno_mean.csv'
env_file = 'results/arq_highfreq_lowpoly_betaprop/lfmm_generation5/env_mean.csv'
num_components_file = 'results/arq_highfreq_lowpoly_betaprop/lfmm_generation5/num_components_mean.txt'

pvalues_file = "results/arq_highfreq_lowpoly_betaprop/lfmm_generation5/p_values_mean.csv"
qqplot_file = "results/arq_highfreq_lowpoly_betaprop/lfmm_generation5/qq_plot_mean.png"
